...
public class AddEdit extends AppCompatActivity {
    EditText txt_id, txt_name, txt_address, txt_phone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void save(){
            if(String.valueOf(txt_name.getText()).equals(null)||String.valueOf(txt_name.getText()).equals("")||
                    ...
                    String.valueOf(txt_phone.getText()).equals("")) {
                ...
                SQLite.insert(txt_name.getText().toString().trim(), txt_address.getText().toString().trim(),txt_phone.getText().toString().trim());
                blank();
                finish();
            }
        }
        ...
        private void edit(){
            if(String.valueOf(txt_name.getText()).equals(null)||String.valueOf(txt_name.getText()).equals("")||
                ...
                SQLite.update(Integer.parseInt(txt_id.getText().toString().trim()),txt_name.getText().toString().trim(),
                        txt_address.getText().toString().trim(), txt_phone.getText().toString().trim());
                blank();
                finish();
            }
        }
