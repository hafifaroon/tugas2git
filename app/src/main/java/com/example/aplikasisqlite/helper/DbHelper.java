...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<HashMap<String, String>> getAllData(){
        ArrayList<HashMap<String, String>> wordLlist;
        wordLlist = new ArrayList<HashMap<String, String>>();
        ...
        Log.e("select sqlite ", ""+ wordLlist);
        database.close();
        return wordLlist;
    }
    public void insert(String name, String address, String phone){
        SQLiteDatabase database = this.getWritableDatabase();
        String queryValues = "INSERT INTO " + TABLE_SQLite + " (name, address, phone) " +
                "VALUES ('" + name + "', '" + address + "', '" + phone + "')";

        Log.e("inset sqlite ", "" + queryValues);
